...
export const AGENT_CONNECTION_SETUPS = [
    ...
    {
        key: 'campaign_chronicler',
        label: 'Campaign Chronicler',
        settingsKeys: {
            connectionSource: 'campaignChroniclerConnectionSource',
            connectionProfileId: 'campaignChroniclerConnectionProfileId',
            completionPresetId: 'campaignChroniclerCompletionPresetId',
            ollamaUrl: 'campaignChroniclerOllamaUrl',
            ollamaModel: 'campaignChroniclerOllamaModel',
            openaiUrl: 'campaignChroniclerOpenaiUrl',
            openaiKey: 'campaignChroniclerOpenaiKey',
            openaiModel: 'campaignChroniclerOpenaiModel',
        },
        ui: {
            source: '#rpg_campaign_chronicler_connection_source',
            profile: '#rpg_campaign_chronicler_connection_profile',
            preset: '#rpg_campaign_chronicler_completion_preset',
            ollamaUrl: '#rpg_campaign_chronicler_ollama_url',
            ollamaModel: '#rpg_campaign_chronicler_ollama_model',
            openaiUrl: '#rpg_campaign_chronicler_openai_url',
            openaiKey: '#rpg_campaign_chronicler_openai_key',
            openaiModel: '#rpg_campaign_chronicler_openai_model',
            openaiManual: '#rpg_campaign_chronicler_openai_model_manual',
            profileGroup: '#rpg_campaign_chronicler_profile_group',
            ollamaGroup: '#rpg_campaign_chronicler_ollama_group',
            openaiGroup: '#rpg_campaign_chronicler_openai_group',
        },
    },
    {
        ...
        settingsKeys: {
            connectionSource: 'campaignArchitectConnectionSource',
            connectionProfileId: 'campaignArchitectConnectionProfileId',
            completionPresetId: 'campaignArchitectCompletionPresetId',
            ollamaUrl: 'campaignArchitectOllamaUrl',
            ollamaModel: 'campaignArchitectOllamaModel',
            openaiUrl: 'campaignArchitectOpenaiUrl',
            openaiKey: 'campaignArchitectOpenaiKey',
            openaiModel: 'campaignArchitectOpenaiModel',
        },
        ui: {
            source: '#rpg_campaign_architect_connection_source',
            profile: '#rpg_campaign_architect_connection_profile',
            preset: '#rpg_campaign_architect_completion_preset',
            ollamaUrl: '#rpg_campaign_architect_ollama_url',
            ollamaModel: '#rpg_campaign_architect_ollama_model',
            openaiUrl: '#rpg_campaign_architect_openai_url',
            openaiKey: '#rpg_campaign_architect_openai_key',
            openaiModel: '#rpg_campaign_architect_openai_model',
            openaiManual: '#rpg_campaign_architect_openai_model_manual',
            profileGroup: '#rpg_campaign_architect_profile_group',
            ollamaGroup: '#rpg_campaign_architect_ollama_group',
            openaiGroup: '#rpg_campaign_architect_openai_group',
        },
    },
    {
        key: 'portraits',
